...
const postsDirectory = path.join(/*turbopackIgnore: true*/ process.cwd(), siteConfig.contentDir || 'content');
...
export function getSortedPostsData() {
      ...
      for (const line of lines) {
        ...
        if (!inCodeBlock) {
          ...
          if (match) {
            ...
            subChapters.push({ title: headingTitle, slug: headingSlug, level });
          }
        }
      }
    }
  ...
  let processedPosts = allPostsData;
